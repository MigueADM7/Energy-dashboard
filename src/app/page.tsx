...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8 scroll-smooth">
        ...
        <section id="proyectos" className="scroll-mt-24 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="flex items-center gap-4 border-l-4 border-l-blue-500">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Consumo Total</p>
                <p className="text-2xl font-extrabold text-slate-800">{metrics.totalUsage} kWh</p>
              </div>
            </Card>
            ...
            <Card className="flex items-center gap-4 border-l-4 border-l-green-500">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Costo Estimado</p>
                <p className="text-2xl font-extrabold text-slate-800">${metrics.totalCost}</p>
              </div>
            </Card>
            ...
            <Card className="flex items-center gap-4 border-l-4 border-l-purple-500">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-500">Pico Máximo</p>
                <p className="text-2xl font-extrabold text-slate-800">{metrics.peak} kWh</p>
              </div>
            </Card>
          </div>
        </section>
